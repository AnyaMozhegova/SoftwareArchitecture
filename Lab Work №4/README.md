...
**cURL:**
```
curl -X POST -H "Content-Type: application/json" -H "Authorization: Bearer {ваш_токен}" -d '{"diet":"vegetarian","allergies": ["nuts","dairy"],"calorie_goal": "2000"}' https://api.example.com/route/
